...
object Eras {
    val all: List<EraConfig> = listOf(
        EraConfig(
            ...
            grain = 0.16f, grainSize = 4.0f, chromaNoise = 0f,
            vignette = 0.80f, vignetteHard = 0.8f,
            softFocus = 0.50f, halation = 0.35f, sharpness = 0f,
            scanline = 0f, chromaShift = 0f, flutter = 0f, flicker = 0.15f, weave = 0.002f,
            dust = 0.50f, leak = 0.12f, leakIndex = 1, resScale = 0.50f,
        ),
        EraConfig(
            ...
            grain = 0.14f, grainSize = 3.6f, chromaNoise = 0.10f,
            vignette = 0.60f, vignetteHard = 0.5f,
            softFocus = 0.35f, halation = 0.25f, sharpness = 0f,
            scanline = 0f, chromaShift = 0f, flutter = 0f, flicker = 0.10f, weave = 0.0015f,
            dust = 0.35f, leak = 0.08f, leakIndex = 1, resScale = 0.55f,
        ),
        EraConfig(
            id = "1920s", label = "1920s", tagline = "Panchromatic B&W · early 35 mm",
            cameraModel = "Leica I", shutterSound = "shutter_plate",
            grain = 0.12f, grainSize = 2.6f, chromaNoise = 0f,
            vignette = 0.45f, vignetteHard = 0.25f,
            softFocus = 0.15f, halation = 0.12f, sharpness = 0f,
            scanline = 0f, chromaShift = 0f, flutter = 0f, flicker = 0.12f, weave = 0.0015f,
            dust = 0.25f, leak = 0f, leakIndex = 0, resScale = 0.62f,
        ),
        EraConfig(
        ...
        EraConfig(
            ...
            dust = 0.22f, leak = 0f, leakIndex = 0, resScale = 0.62f,
        ),
        EraConfig(
            ...
            scanline = 0f, chromaShift = 0f, flutter = 0f, flicker = 0f, weave = 0f,
            dust = 0.08f, leak = 0.35f, leakIndex = 0, resScale = 0.76f,
        ),
        EraConfig(
            ...
            scanline = 0f, chromaShift = 0f, flutter = 0f, flicker = 0f, weave = 0f,
            dust = 0f, leak = 0f, leakIndex = 0, resScale = 0.90f,
        ),
        EraConfig(
        ...
        EraConfig(
            ...
            scanline = 0f, chromaShift = 0f, flutter = 0f, flicker = 0f, weave = 0f,
            dust = 0f, leak = 0f, leakIndex = 0, resScale = 0.95f,
        ),
        EraConfig(
